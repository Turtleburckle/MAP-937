...
public class ArithmeticExpression implements Expression{
    ...
    public String toString()
    {
        ...
        arithmeticExpressionString += firstExpression.toString();
        if (operation.equals(OperationsWithIntegers.SUM)){arithmeticExpressionString += " + ";}
        else if (operation.equals(OperationsWithIntegers.DIFFERENCE)){arithmeticExpressionString += " - ";}
        else if (operation.equals(OperationsWithIntegers.MULTIPLICATION)){arithmeticExpressionString += " * ";}
        else if (operation.equals(OperationsWithIntegers.DIVISION)){arithmeticExpressionString += " / ";}
        arithmeticExpressionString += secondExpression.toString();
        return arithmeticExpressionString;
    }
}
