...
//    }
    ...
    @Override
    public void oneStepForGUI(int programStateIndex) throws MyExceptions
    {
        List<ProgramState> programStates = this.getAllStates();
        ProgramState programState = programStates.get(programStateIndex);
        this.repository.logProgramStateExecutable(programState);
        this.oneStepForAllPrograms((List<ProgramState>) programState);
        //this.repository.setProgramStates((MyList<ProgramState>) programState);
        //this.repository.setProgramStates(programState);

    }
    /*@Override
    public void oneStepForGUI() throws MyExceptions{
